...
```bash
git clone https://github.com/ArjunKunnath/facial-emotion-recognition.git
...
<p align="center"> <img src="diagram.png" alt="Facial Emotion Recognition Architecture Diagram" width="400"> </p>
